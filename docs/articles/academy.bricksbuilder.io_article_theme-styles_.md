...
date: 2026-01-05T11:09:19.839278
status: success
---
...
By default, Bricks loads only themost specifictheme style on a page.
...
You can change this behavior underWordPress Admin > Bricks > Settings > General > Theme Styles: Loading Method

` WordPress Admin > Bricks > Settings > General > Theme Styles: Loading Method`
