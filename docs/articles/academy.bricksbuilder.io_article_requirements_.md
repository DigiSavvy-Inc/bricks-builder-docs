...
date: 2026-01-05T11:09:26.721295
status: success
---
...
You can defineWP_MEMORY_LIMITby adding the following code to yourwp-config.phpfile, above the line that says “That’s all, stop editing!”:
...
A maximum upload size should be 64 MB or more. Log into your hosting account and change the following twoPHP server settingsto:
